...
class ModelCatalogProduct extends Model {
	...
	/**
	 * Возвращает продукт по UPC (уникальный код продукта).
	 * В это поле мы записываем IdDetail, полученный от поставщика.
	 */
	public function getProductIdByUpc($upc) {
		$sql = "SELECT product_id FROM " . DB_PREFIX . "product
		WHERE upc = '" . (int)$upc."' LIMIT 1";
